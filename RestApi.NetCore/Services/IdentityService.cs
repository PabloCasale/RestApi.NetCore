...
namespace RestApi.NetCore.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<IdentityUser> userManager, JwtSettings jwtSettings, TokenValidationParameters tokenValidationParameters, DataContext db)
        {
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string token, string refreshToken)
        {
            ...
            {
                return new AuthenticationResult { Errors = new[] { "This refresh token doesn't exists." } };
            }
